...
# This problem is pretty meta...
YOUR_SYSTEM_PROMPT = """You are a helpful assistant with access to tools. When asked to call a tool, respond with a JSON object containing the tool name and arguments.
